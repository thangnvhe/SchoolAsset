...
namespace SchoolAsset.DataLayer.Migrations
{
    ...
    [Migration("20250329201751_addSomeTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolAsset.DataLayer.Models.Asset", b =>
                {
            ...
            modelBuilder.Entity("SchoolAsset.DataLayer.Models.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAsset.DataLayer.Models.Asset", b =>
                {
                    b.HasOne("SchoolAsset.DataLayer.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolAsset.DataLayer.Models.Room", "Room")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolAsset.DataLayer.Models.Maintenance", b =>
                {
                    b.HasOne("SchoolAsset.DataLayer.Models.Asset", "Asset")
                        .WithMany()
